...
T = importlib.import_module("importance_d12_target_v66")


class D12TargetV66Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_negative_transfer_is_excluded(self):
    ...
    def test_gate_generation_is_blocked_before_independent_v66_pass(self):
        self.assertEqual(T.V66_AUDIT_ARTIFACT_HASHES, {})
        with self.assertRaises(ValueError):
            T.validate_v66_audit_artifacts()

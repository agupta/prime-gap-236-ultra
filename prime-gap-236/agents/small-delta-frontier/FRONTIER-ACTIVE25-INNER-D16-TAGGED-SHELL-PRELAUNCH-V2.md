...
This v2 document is the only staged-wrapper candidate offered for a fresh
implementation audit.  The earlier claimed unversioned staged tuple
`d1b2d5c1.../e252b0c4...` is withdrawn: the files moved after those hashes
were reported.  The later observed unversioned draft
`bb00675f.../77ab338b...` is also not a launch tuple.  It was copied once to
the distinct v2 paths below; only the v2 test was then changed, mechanically,
to import the v2 wrapper.  The arithmetic core, gate, cost artifacts, and
mathematical formulas did not change.
...
- gate verifier: SHA
  ...
  PASS normal and `-O`;
- staged v2 wrapper `frontier_active25_inner_d16_staged_v2.py`: SHA
  `bb00675f722a843c0d87ef36e382aea812d6622c79da517e238b0146af9592dd`;
- staged v2 tests `test_frontier_active25_inner_d16_staged_v2.py`: SHA
...
python3 agents/small-delta-frontier/frontier_active25_inner_d16_staged_v2.py --preflight-only
```

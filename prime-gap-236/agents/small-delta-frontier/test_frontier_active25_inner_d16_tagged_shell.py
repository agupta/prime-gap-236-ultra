...
SOURCE = FILE.with_name("frontier_active25_inner_d16_tagged_shell.py")
...
class FrontierInnerShellTests(unittest.TestCase):
    def test_frozen_candidate_identity(self):
        ...
        self.assertEqual(M.SCHEDULE[9], Q(3329, 20000))
        self.assertEqual(M.SCHEDULE[-2:], (Q(363, 2000),) * 2)
        self.assertEqual(len(M.SCHEDULE), 26)
